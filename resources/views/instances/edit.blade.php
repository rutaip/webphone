...
@section('content')
    ...
    {!! Form::model($instance, ['method' => 'PATCH', 'url' => 'instances/' . $instance->id]) !!}
    ...
    <div class="row">
        <div class="col-md-6">
            <table class="table table-bordered">
                ...
                <tr>
                    <th scope=row>{!! Form::label('rtcweb_breaker', 'RTCWeb Breaker') !!}</th>
                    <td>{!! Form::text('rtcweb_breaker', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'true']) !!}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>{!! Form::label('video_enable', 'Enable Video') !!}</th>
                    <td>{!! Form::text('video_enable', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'true']) !!}</td>
                </tr>
                <tr>
